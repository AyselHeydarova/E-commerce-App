...
import {StyleSheet, StatusBar, View, Image, TouchableOpacity, TouchableWithoutFeedback, Text} from 'react-native';
        ...
        <View style={styles.container}>
            ...
            <View style={styles.bodyPart}>
                <View style={styles.titleContainer}>
                    <CustomText weight={'medium'} style={styles.title}>Shipping Address </CustomText>
                </View>
            ...
            <View style={styles.bodyPart}>
                ...
                <View style={[styles.section, {height: 100}]}>
                    ...
                    <Image
                        ...
                        source={{uri: 'https://cdnuploads.aa.com.tr/uploads/Contents/2020/05/21/thumbs_b_c_734048bfd3b897e3a838fe7dbe4d2bcb.jpg?v=144915'}}/>
                    <Image
                        style={styles.deliveryImgWrapper}
                        source={{uri: 'https://d1yjjnpx0p53s8.cloudfront.net/styles/logo-thumbnail/s3/042018/untitled-1_102.png?5lnaGj371nVr0mbE.uvCG3dfRcjQIgZL&itok=f3Iwenu5'}}/>
                    <Image
                        style={styles.deliveryImgWrapper}
                        source={{uri: 'https://ru.epackagingsrl.com/wp-content/uploads/2018/05/dhl-logo.jpg'}}/>
                </View>
            </View>
            <View style={styles.bodyPart}>
                <View style={styles.titleContainer}>
