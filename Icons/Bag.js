...
export const Bag = ({ width, height, isBagClicked=false, style ,onPress}) => {
    ...
    return (
        <TouchableOpacity style={[styles.container, style]} onPress={onPress}>
            <Svg height={height} viewBox="0 0 512 512" width={width}>
                ...
                7.98-7.47 8.25-4.66.3-8.53-3.39-8.53-7.98v-93c0-36.94 30.06-67 67-67s67 30.06 67 67z"  fill={isBagClicked?COLORS.DARK:COLORS.TEXT} />
            </Svg>
        </TouchableOpacity>
    );
};
